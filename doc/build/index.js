...
kg/trees/2.0.0/view
kg/trees/2.0.0/list
kg/trees/2.0.0/select
kg/trees/2.0.0/city
kg/trees/2.0.0/index
...
* @date: 2013-05-3
*/
KISSY.add('kg/trees/2.0.0/tree',function(S, STree, Base){
	var DOM = S.DOM,
		Event = S.Event;
		...
		*/
		...
		_checkNodeLoaded: function(node, func, arg){
			...
			if(!isLazyLoad){
				...
				checkTimer = setInterval(intervalFunc, 2.0.0);
			}
		},
...
* @version 2.0
*/
KISSY.add('kg/trees/2.0.0/view',function(S, Base, ViewStore){
...
* @version 2.0
*/
KISSY.add('kg/trees/2.0.0/list',function(S, View){
	var DOM = S.DOM,
		Event = S.Event;
...
* @version 2.0
*/
KISSY.add('kg/trees/2.0.0/select',function(S, View){
...
* @version 2.0
*/
KISSY.add('kg/trees/2.0.0/city',function(S, Select){
	var DOM = S.DOM,
		Event = S.Event;
 ...
 * @module trees
 **/
KISSY.add('kg/trees/2.0.0/index',function(S, Store, Base, Tree, ViewStore, View, List, Select, City){
	/**
	* Trees组件入口类
	*/
	var Trees = {};
